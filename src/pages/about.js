			...
			<div className="aboutPage">
				<div className="aboutPage-content">
					...
					<p>
						...
						aspect of coding. I fell in love with this aspect of Linguistics and went on to take CompLin II the next semester.
						I wanted to immerse myself into the tech community, so I spontaneously decided to go to a Hackathon, although I did not have
